...
public class Calc extends javax.swing.JFrame {
    ...
    public Calc() {
        ...
        JOptionPane.showMessageDialog(this,"Selamat datang di Kalkulator Building Computer!", "Welcome", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void initComponents() {
            ...
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/excee/OneDrive/Documents/NetBeansProjects/UTSGui/UTSGui/UTSGui/UtsGuiV2/src/main/java/img/MSI.png")
                    );
        ...
        jLabel7.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/excee/OneDrive/Documents/NetBeansProjects/UTSGui/UTSGui/UTSGui/UtsGuiV2/src/main/java/img/AORUS.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
        ...
        jLabel8.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/excee/OneDrive/Documents/NetBeansProjects/UTSGui/UTSGui/UTSGui/UtsGuiV2/src/main/java/img/Lenovo.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
        ...
        jLabel10.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("file:/C:/Users/excee/OneDrive/Documents/NetBeansProjects/UTSGui/UTSGui/UTSGui/UtsGuiV2/src/main/java/img/ROG.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
...
//        Bundle
        ...
        // Mengambil dan menghitung total harga
        txtHasil.setText("Spesifikasi Komputer anda :" + "\n" + "\nProcessor\t: " + pilihProcessor
        ...
        answer = JOptionPane.showConfirmDialog(this, "Cek harga?");
        
        switch (answer) {
            case JOptionPane.YES_OPTION:
                JOptionPane.showMessageDialog(this, "Total Harga : Rp. " + totalHarga, "cek", JOptionPane.INFORMATION_MESSAGE);
                break;
    ...
    private void btnPesanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesanActionPerformed
        ...
        hasilPesanan = txtHasil.getText();  // Jika txtHasil adalah JTextArea

        answer = JOptionPane.showConfirmDialog(this, "Apakah pilihan spek anda sudah benar?");

        switch (answer) {
            case JOptionPane.YES_OPTION:
                // Mengambil input dari pengguna untuk data pelanggan
                namaPelanggan = JOptionPane.showInputDialog(this, "Masukkan nama kamu ");
                nomorPelanggan = JOptionPane.showInputDialog(this, "Masukkan nomor telepon ");
                alamatPelanggan = JOptionPane.showInputDialog(this, "Masukkan alamat kamu ");
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        // TODO add your handling code here:
        answer = JOptionPane.showConfirmDialog(this, "Ingin Hapus Pilihan?");
    ...
    private void btnKeluarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnKeluarActionPerformed
        // TODO add your handling code here:
        answer = JOptionPane.showConfirmDialog(this, "Yakin ingin keluar dari program?");
